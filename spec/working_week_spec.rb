...
describe GBWorksDay::WorkWeek do
  ...
  context 'free days' do
    it 'should calculates free days for 7 days work and start on any day' do
      week = GBWorksDay::WorkWeek.new(7, rand(6)+1)
